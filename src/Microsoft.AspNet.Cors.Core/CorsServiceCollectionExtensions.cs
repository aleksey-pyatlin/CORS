...
namespace Microsoft.Framework.DependencyInjection
{
    ...
    public static class CorsServiceCollectionExtensions
    {
        ...
        /// <param name="config">An optional configuration which can be applied to the <see cref="ServiceDescriber"/>.
        /// </param>
        /// <returns>The updated <see cref="IServiceCollection"/>.</returns>
        public static IServiceCollection AddCors(this IServiceCollection serviceCollection, IConfiguration config = null)
        {
            var describe = new ServiceDescriber(config);
            serviceCollection.AddOptions(config);
            serviceCollection.TryAdd(describe.Transient<ICorsEngine, CorsEngine>());
