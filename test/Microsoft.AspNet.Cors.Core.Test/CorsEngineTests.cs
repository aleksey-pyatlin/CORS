...
namespace Microsoft.AspNet.Cors.Core.Test
{
    public class CorsEngineTests
    {
        ...
        {
            var engine = new CorsEngine(Mock.Of<IOptions<CorsOptions>>());
            var corsRequestContext = GetHttpContext(
                CorsConstants.PreflightHttpMethod,
                "http://localhost:5001/",
                "PUT",
                new[] { "AllowedHeader1" });
            var result = engine.EvaluatePolicy(corsRequestContext, AllowAllPolicy);
        ...
        public void PreFlight_Request_With_AllowAllWithCredentials_Policy()
        {
            ...
            var result = engine.EvaluatePolicy(corsRequestContext, AllowAllPolicyWithCredentials);
        ...
        public void PreFlight_Request_With_SpecificUrl_Policy_For_Unallowed_Origin()
        {
            ...
            var corsRequestContext = GetHttpContext(
                ...
                "http://localhost:5001",
                "PUT");
            var result = engine.EvaluatePolicy(corsRequestContext, AllowSpecificUrlPolicy);
        ...
        public void PreFlight_Request_With_SpecificUrl_Policy_With_Both_Allowed_And_NotAllowed_Header()
        {
            ...
            var corsRequestContext = GetHttpContext(
                ...
                "http://localhost:5001/sub",
                "PUT",
                new[] { "AllowedHeader1", "AllowedHeader2" });
            var result = engine.EvaluatePolicy(corsRequestContext, AllowSpecificUrlPolicy);
